...
public class AppUtils {
    ...
    public static final String AUTHORITIES = "com.hackhome.loans.provider";
...
//        return getAppSignature(LoanApplication.getInstance().getPackageName());
//    }
...
//        return getAppSignatureSHA1(LoanApplication.getInstance().getPackageName());
//    }
...
//                (ActivityManager) LoanApplication.getInstance().getSystemService(Context.ACTIVITY_SERVICE);
//        List<ActivityManager.RunningAppProcessInfo> info = manager.getRunningAppProcesses();
//        if (info == null || info.size() == 0) return false;
//        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
//            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
//                return aInfo.processName.equals(LoanApplication.getInstance().getPackageName());
//            }
//        }
//        return false;
//    }
