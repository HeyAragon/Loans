package com.hackhome.loans.widget.bottombar;
...
public class BottomBarItem extends LinearLayout {
    ...
    public BottomBarItem(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, DensityUtil.sp2px(mContext, mTextSize));
        ...
        mMarginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, DensityUtil.dip2px(mContext, mMarginTop));
        ...
        mUnreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, DensityUtil.sp2px(mContext, mUnreadTextSize));
        mMsgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, DensityUtil.sp2px(mContext, mMsgTextSize));
