...
public class DownloadProgressButton extends AppCompatTextView {
    ...
    //点的间隙
    private float mBallSpacing = 2;
    //点的半径
    private float mBallRadius = 3;
    //是否显示边框，默认是true
    ...
    public static final int STATE_PENDDING = 1;//等待中
    public static final int STATE_DOWNLOADING = 3;//下载之中
    public static final int STATE_PAUSE = -2;//暂停下载
    public static final int STATE_FINISH = -3;//下载完成
    public static final int STATE_INSTALLED = 4;//已安装
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            mBackgroundColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_background_color, Color.parseColor("#3385FF"));//blue
            mBackgroundSecondColor = a.getColor(R.styleable.DownloadProgressButton_progress_btn_background_second_color, Color.parseColor("#E8E8E8"));//gray
    ...
    private synchronized void drawing(Canvas canvas) {
    ...
    public final void setCurrentText(@StringRes int resId) {
        setCurrentText(getContext().getResources().getText(resId));
    }
