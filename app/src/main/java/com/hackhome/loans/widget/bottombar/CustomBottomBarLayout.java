 ...
 * date: 2018/1/17 0017.
 */
public class CustomBottomBarLayout extends LinearLayout implements ViewPager.OnPageChangeListener{
    ...
    public CustomBottomBarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomBottomBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
